    ...
    return <div className="px-6 sm:px-10 desktop:px-0 max-w-[1300px] mx-auto flex  flex-col-reverse mdd:flex-row pb-[101px] mdd:pb-[126px] gap-10 ">
        <div className="relative sm:pt-[80px] xl:pt-[102px] flex flex-col mdd:max-w-[471px] ">
            ...
            <div className="h-[54px] pl-[17px] pr-[7px] flex items-center border rounded-full gap-[15px] mb-[34px]">
                ...
                <input type="text" className="flex-1 text-[18px] " placeholder="Search food" />
                <div className="w-[42px] h-[42px] rounded-full flex items-center justify-center bg-yellow_1  m-auto">
                    <SearchIcon color="white" />
                </div>
            </div>
            <div className="flex items-center gap-[31px]">
                <button className=" rounded-full h-[46px] px-5 text-white bg-red_1">Download App</button>
                <button className="flex items-center gap-[21px]">
                    <div className="rounded-full shadowbtn h-[52px] w-[52px] flex items-center justify-center" >
                        <img src={PlayBtn} alt="" />
                    </div>
                    <span className="text-[17px] font-medium text-[#686D77]">Watch Video</span>
                </button>
            </div>
